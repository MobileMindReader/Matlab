...
% Load data files
path=('exp_alpha_modes_func_iter/');
files = dir(path);
...
for data=dataFiles
    ...
    if data.descriptino(1:24) == '25x iter functions, 10 w'
...
dataSeparateAlphas=dataFiles{1};
...
numExperimentsMSeparate = size(w_model_separate_true,2);
numExperimentsMShared = size(w_model_shared_true,2);
...
for i=1:iterations
    % Separate alpha
    w_mse_model_separate_estimate_separate(1:numel(w_model_separate_true{i,1}),i) = (w_model_separate_estimate_separate{i,1}-w_model_separate_true{i,1}).^2;
    w_mse_model_separate_estimate_shared(1:numel(w_model_separate_true{i,1}),i) = (w_model_separate_estimate_shared{i,1}-w_model_separate_true{i,1}).^2;
    % Shared alpha model
    w_mse_model_shared_estimate_separate(1:numel(w_model_shared_true{i,1}),i) = (w_model_shared_estimate_separate{i,1}-w_model_shared_true{i,1}).^2;
    w_mse_model_shared_estimate_shared(1:numel(w_model_shared_true{i,1}),i) = (w_model_shared_estimate_shared{i,1}-w_model_shared_true{i,1}).^2;
    
    for j=2:numExperimentsMSeparate
        % Separate alpha model
        w_mse_model_separate_estimate_separate(1:numel(w_model_separate_true{i,1}),i) = w_mse_model_separate_estimate_separate(:,i) + (w_model_separate_estimate_separate{i,j}-w_model_separate_true{i,j}).^2;
        w_mse_model_separate_estimate_shared(1:numel(w_model_separate_true{i,1}),i) = w_mse_model_separate_estimate_shared(:,i) + (w_model_separate_estimate_shared{i,j}-w_model_separate_true{i,j}).^2;
    end
    for j=2:numExperimentsMShared
        % Shared alpha model
        w_mse_model_shared_estimate_separate(1:numel(w_model_shared_true{i,1}),i) = w_mse_model_shared_estimate_separate(:,i) + (w_model_shared_estimate_separate{i,j}-w_model_shared_true{i,j}).^2;
        w_mse_model_shared_estimate_shared(1:numel(w_model_shared_true{i,1}),i) = w_mse_model_shared_estimate_shared(:,i) + (w_model_shared_estimate_shared{i,j}-w_model_shared_true{i,j}).^2;
    end
...
xlabel(['#functions, averaged over ' int2str(numExperimentsMSeparate) ' experiments']), ylabel('Sum of MSE for all weights') 
...
xlabel('# functions'), ylabel(['mean alpha value of ' int2str(numExperimentsMSeparate) ' experiments']) 
...
for i=1:iterations
    for j=1:numExperimentsMSeparate
        % Separate priors
...
ylabel(['MSE of alpha averaged over ' int2str(numExperimentsMSeparate) ' experiments']);
xlabel('# of samples');
...
ylabel(['alpha/beta ratio averaged over ' int2str(numExperimentsMSeparate) ' experiments']);
xlabel('# of samples');
...
llh_norm_model_shared_estimate_separate = zeros(iterations, numExperimentsMSeparate);
llh_norm_model_shared_estimate_shared = zeros(iterations, numExperimentsMSeparate);

llh_norm_model_separate_estimate_separate = zeros(iterations, numExperimentsMSeparate);
llh_norm_model_separate_estimate_shared = zeros(iterations, numExperimentsMSeparate);
...
legend('Separate', 'Shared');
xlabel('# of samples'), ylabel(['Log likelihood averaged over ' int2str(numExperimentsMSeparate) ' experiments']);
...
a_active_model_separate_estimate_separate = zeros(iterations,numExperimentsMSeparate,active_functions);
a_active_model_shared_estimate_separate = zeros(iterations,numExperimentsMSeparate,100);
...
title('Alpha estimation in shared prior model'), ylabel(['alpha averaged over ' int2str(numExperimentsMSeparate) ' experiments']);
xlabel('# of samples');
% (std/sqrt(N))
...
title('Alpha estimation in separate prior model (First 10 functions assumed active)'), ylabel(['alpha averaged over ' int2str(numExperimentsMSeparate) ' experiments']);
xlabel('# of samples');
...
ylabel(['beta averaged over ' int2str(numExperimentsMSeparate) ' experiments']);
xlabel('# of samples');
